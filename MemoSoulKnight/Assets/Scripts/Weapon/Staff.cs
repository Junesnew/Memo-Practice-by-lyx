...
public class Staff : Weapon 
{
    ...
    override public void Attack()
    {
        ...
        for (i = 0; i < 12; i++)
        {
            obj.GetComponent<BulletPool>().getBullet(4, Quaternion.AngleAxis((float)30*i, new Vector3(0, 0, 1f)) * (new Vector3(mousePos.x - x, mousePos.y - y, 0f)), 3.0f, new Vector3(x, y, 0f));
        }
