...
public class Gatling : Weapon
{
    ...
    override public void Attack()
    {
        ...
        for (i = -1; i < 2; i++)
        {
            obj.GetComponent<BulletPool>().getBullet(4, Quaternion.AngleAxis((float)i*15, new Vector3(0, 0, 1f)) * (new Vector3(mousePos.x - x, mousePos.y - y, 0f)), 3.0f, new Vector3(x, y, 0f));
        }
